...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#c2c2c2'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '50px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '32px', 'lineheight' => '45px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '28px', 'lineheight' => '39px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '34px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '28px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#434343'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '54px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#dfdfdf'));

			$options['fooer_logo_url'] = array( "name" => 'Footer '.theme_locals('logo_image_path'),
